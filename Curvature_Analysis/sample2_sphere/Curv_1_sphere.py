...
# Main code
R_squared_limit = 0.9
patch_distance = 1  # unit: nm

# Saving the file and diagrams
# Plotting the points
points = generate_sphere_points(5000, r=5, center=(30, 30, 30))  # Insert the points of the surface you want to analyze
...
# Saving the curvature parameters as a text file
save_text(
    points,
    header="\t\tX\t\t\t\tY\t\t\t\tZ\n",
    path='points.txt'
